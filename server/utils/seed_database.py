...
from models import Category, Game, Publisher, db
...
def create_games():
    ...
    with app.app_context():
        ...
        csv_path = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "seed_data", "games.csv"
        )
        ...
        with open(csv_path, mode="r", encoding="utf-8") as csv_file:
            ...
            for row in csv_reader:
                ...
                if publisher_name not in publishers:
                    ...
                    publisher = Publisher(
                        name=publisher_name, description=publisher_description
                    )
                ...
                game = Game(
                    ...
                    + " Support this game through our crowdfunding platform!",
        ...
        print(
            f"Added {game_count} games with {len(categories)} categories and {len(publishers)} publishers"
        )
